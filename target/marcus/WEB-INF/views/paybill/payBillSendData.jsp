...
<body onload="document.forms['customerData'].submit()">
			...
			<form method="post" name="customerData" action="payBillRequestHandler" >
				...
				<input type="hidden" name="redirect_url" value="http://52.172.215.71/payBillResponseHandler"/><!-- Redirect URL	: -->
				<input type="hidden" name="cancel_url" value="http://52.172.215.71/ccvCancelResponse"/><!-- Cancel URL	: -->
