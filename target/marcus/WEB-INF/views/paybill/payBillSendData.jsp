...
<body onload="document.forms['customerData'].submit()">
			...
			<form method="post" name="customerData" action="payBillRequestHandler" >
				...
				<input type="hidden" name="redirect_url" value="${pageContext.request.contextPath }/payBillResponseHandler"/><!-- Redirect URL	: -->
				<input type="hidden" name="cancel_url" value="${pageContext.request.contextPath }/ccvCancelResponse"/><!-- Cancel URL	: -->
