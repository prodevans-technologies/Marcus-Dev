                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                        ...
                        <p class="faqp1"><br/><br/>The User agrees to use the services provided by STOIC-MARCUS<sup>TM</sup>, its affiliates, consultants and contracted companies, for lawful purposes only.
                            ...
                            <br/><br/> In no event shall STOIC-MARCUS<sup>TM</sup> be liable for any direct, indirect, punitive, incidental, special, consequential damages or any damages whatsoever including, without limitation, damages for loss of use, data or profits, arising out of or in any way connected with the use or performance of the website, with the delay or inability to use the website or related services, the provision of or failure to provide services, or for any information, software, products, services and related graphics obtained through the website, or otherwise arising out of the use of the website, whether based on contract, or otherwise, even if STOIC-MARCUS<sup>TM</sup> as the website owner has been advised of the possibility of damages. 
                            <br/><br/> Indemnity: User shall indemnify and hold harmless STOIC-MARCUS<sup>TM</sup> and (as applicable) STOIC-MARCUS<sup>TM</sup>'s parent, subsidiaries, affiliates, third-parties and their respective officers, directors, agents, and employees, from any claim or demand, or actions including reasonable attorneys' fees, made by any third party or penalty imposed due to or arising out of your breach of this Agreement. 
                            ...
                            <br/><br/> In no event shall STOIC-MARCUS<sup>TM</sup> be liable for any direct, indirect, punitive, incidental, special, consequential damages or any damages whatsoever including, without limitation, damages for loss of use, data or profits, arising out of or in any way connected with the use or performance of the website, with the delay or inability to use the website or related services, the provision of or failure to provide services, or for any information, software, products, services and related graphics obtained through the website, or otherwise arising out of the use of the website, whether based on contract, or otherwise, even if STOIC-MARCUS<sup>TM</sup> as the website owner has been advised of the possibility of damages. 
                            <br/><br/> The User agrees that STOIC-MARCUS<sup>TM</sup> has the right to disclose to third parties Registration Data to the extent necessary for the purpose of carrying out the Services. 
                            <br/><br/> Termination /Suspension- STOIC-MARCUS<sup>TM</sup> reserves its right to refuse service, restrict, suspend, terminate user account; (Terminate this Agreement; Terminate or suspend user access to the Web Sites; Move, or remove any product or service that is available on or through the Services; Deactivate or delete user accounts and all related information and files in your account; Establish general practices and limits concerning use of this Site) at any time, in its sole discretion with or without cause, and with or without any prior notice for any violation of the Terms of Use. Upon such termination or suspension, your right to use the STOIC-MARCUS<sup>TM</sup>'s Web Sites will immediately cease. Once the User's registration or the Services are terminated, cancelled or suspended, any data that the User has stored on the Website may not be retrieved later. 
                            <br/><br/> The User agrees that STOIC-MARCUS<sup>TM</sup> may under certain circumstances and without prior notice, immediately terminate the User's user ID and access to the Website/Services. Causes for termination may include, but shall not be limited to requests by enforcement or government agencies, etc 
                            <br/><br/> User shall consent to receive SMS / email or any such Electronic / Written communications from STOIC-MARCUS<sup>TM</sup>. 
       ...
       <div id="container-floating">
            <div id="floating-button" data-toggle="tooltip">
                <p class="plus valign" style="padding-top: 8px;" >
                    ...
                    <br>
                    <a class="external" style="color: #ffffff; font-size: 10px;" href="newconnection.html">
                        New
                        Connection
                    </a>
                </p>
