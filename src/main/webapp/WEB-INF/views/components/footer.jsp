        ...
        <div class="col-md-12">
            <footer>
                <div class="footer-bottom">
                    <div  >
                        <p class="pull-left" style="font-size:13px; padding-top: 10px;" > &copy; COPYRIGHT ONE8 TECHNOLOGIES <script type="text/JavaScript">document.write(new Date().getFullYear());</script></p>
